...
public interface ReplyRepository extends JpaRepository<Reply,Long> {
    ...
    @Query("SELECT r FROM Reply r LEFT JOIN FETCH r.member m LEFT JOIN FETCH m.roles WHERE r.post = :post AND r.isDeleted = false AND r.likeCount>=5 ORDER BY r.likeCount DESC, r.id DESC  LIMIT 3")

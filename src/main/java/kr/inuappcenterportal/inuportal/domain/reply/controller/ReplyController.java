...
public class ReplyController {
    ...
    public ResponseEntity<ResponseDto<LikeAction>> likePost(@AuthenticationPrincipal Member member, @Parameter(name = "replyId",description = "댓글의 id",in = ParameterIn.PATH)@PathVariable Long replyId){
